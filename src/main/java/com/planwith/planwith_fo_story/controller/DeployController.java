package com.planwith.planwith_fo_story.controller;
...
import com.planwith.planwith_fo_story.service.AuthService;
...
@Validated
@RestController
@RequestMapping("/api/planwith-fo-story")
@Tag(name = "planwith-fo-story", description = "Server notebook deploy verification API")
